# Boas vindas ao repositório do projeto de Job Insights!
...
Neste projeto eu implementei análises a partir de um conjunto de dados sobre empregos. Suas implementações foram incorporadas a um aplicativo Web desenvolvido com Flask (um framework web muito popular na comunidade Python). Eu também tive a oportunidade de escrever testes para a implementação de uma análise de dados. Por fim, como bônus, eu tive o desafio de escrever uma rota e view para um recurso novo usando Flask!
...
```bash
git clone git@github.com:apaulinhacarlos/trybe-cs-job-insights.git
```

Acesse o diretório do projeto com o comando `cd`:

```bash
cd trybe-cs-job-insights
```
